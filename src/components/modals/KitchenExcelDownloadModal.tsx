...
interface KitchenExcelDownloadModalProps {
    isOpen: boolean;
    onClose: () => void;
    onDownload: () => void;
    isLoading?: boolean;
...
export default function KitchenExcelDownloadModal({
    isOpen,
    onClose,
    onDownload,
    isLoading = false,
...
}: KitchenExcelDownloadModalProps) {
            ...
            <div className="p-6">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Выберите период и поставщика для скачивания кухни
                    </p>
                </div>
